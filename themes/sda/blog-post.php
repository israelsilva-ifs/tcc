    ...
    <article class="post_page">
        <header class="post_page_header">
            <div class="post_page_hero">
                ...
                <img class="post_page_cover" alt="" title="" src="<?= theme("/assets/img/home-featured.jpg"); ?>"/>
                <div class="post_page_meta">
                    <div class="author">
                        <div><img src="<?= theme("/assets/img/avatar.jpg"); ?>"/></div>
        ...
        <div class="post_page_content">
            <div class="htmlchars">
                ...
                <img alt="" title="" src="<?= theme("/assets/img/home-featured.jpg"); ?>"/>
