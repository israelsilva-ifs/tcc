...
<head>
    ...
    <title><?= $this->e(CONF_SITE_NAME) ?> | Admin</title>
    <!-- Custom fonts for this template-->
    <link rel="stylesheet" href="<?= theme('assets/css/style.css') ?>">
    <link rel="stylesheet" href="<?= theme('assets/')?>">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= url() ?>">
            ...
            <div class="sidebar-brand-text mx-3">SDA Admin <sup>2</sup></div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= url('/professores') ?>">Professores</a>
                    <a class="collapse-item" href="<?= url('/usuarios') ?>">Usuarios</a>
                    <a class="collapse-item" href="<?= url('/disciplinas') ?>">Disciplinas</a>
                </div>
            </div>
        </li>
                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="img-profile rounded-circle"
                                 src="<?= theme('assets/img/undraw_profile.svg') ?>">
                        </a>
...
<script src="https://kit.fontawesome.com/0473c227d5.js" crossorigin="anonymous"></script>
...
<!-- Page level custom scripts aqui neste js ficam os graficos da dashboard e home -->
